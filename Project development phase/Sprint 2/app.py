...
def upload():
    ...
    if request.method == 'POST':
        ...
        with graph.as_default():
            ...
            json_file = open('/Project Development Phase/Sprint 2/DigitalNaturalist.json', 'r')
            loaded_model_json = json_file.read()
            json_file.close()
            loaded_model = model_from_json(loaded_model_json)
            #adding weights to the trained model
            loaded_model.load_weights("/Project Development Phase/Sprint 2/DigitalNaturalist.h5")
